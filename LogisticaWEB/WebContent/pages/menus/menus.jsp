...
<head>
	...
	<script type="text/javascript" src="/LogisticaWEB/pages/menus/menus.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="/LogisticaWEB/pages/menus/menus.css"/>
</head>
<body>
...
<%@ include file="/includes/menu.jsp" %>
	...
	<div id="divIFrameMenu" style="display: none;">
		...
		<iframe id="iFrameMenu" frameborder="0" src="#"></iframe>
	</div>
