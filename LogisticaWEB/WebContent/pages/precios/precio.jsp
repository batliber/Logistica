...
<head>
	...
	<script type="text/javascript" src="/LogisticaWEB/pages/precios/precio.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="/LogisticaWEB/pages/precios/precio.css"/>
</head>
<body>
...
<%@ include file="/includes/menu.jsp" %>
	...
	<div id="divIFramePrecio" style="display: none;">
		...
		<iframe id="iFramePrecio" frameborder="0" src="#"></iframe>
	</div>
