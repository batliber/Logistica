...
<head>
	...
	<script type="text/javascript" src="/LogisticaWEB/pages/backoffice/backoffice.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="/LogisticaWEB/pages/backoffice/backoffice.css"/>
</head>
<body>
	...
	<div id="divIFrameSeleccionBackoffice" style="display: none;">
		...
		<div id="divSeleccionBackoffice">
			...
			<div class="divPopupWindow">
				<div class="divFormLabelExtended">Backoffice:</div><div id="divBackoffice" class="divFormValue"><select id="selectBackoffice"></select></div>
