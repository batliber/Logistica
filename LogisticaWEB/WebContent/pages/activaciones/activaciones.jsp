...
<%@ include file="/includes/header.jsp" %>
	...
	<script type="text/javascript" src="./activaciones.js"></script>
	<link rel="stylesheet" type="text/css" href="./activaciones.css"/>
</head>
<body>
...
<%@ include file="/includes/menu.jsp" %>
	...
	<div class="divBodyContainer">
		<div class="divBody">
			<div class="divButtonBar">
				...
				<form method="post" id="formExportarAExcelSupervisorDistribucionChips" action="#"></form>
				<div class="divButton" id="divButtonExportarAExcelSupervisorDistribucionChips"><input type="submit" id="inputExportarAExcelSupervisorDistribucionChips" value="Exporta a Excel" onclick="javascript:inputExportarAExcelSupervisorDistribucionChipsOnClick(event, this)"/></div>
				<form method="post" id="formExportarAExcelEncargadoActivaciones" action="#"></form>
				<div class="divButton" id="divButtonExportarAExcelEncargadoActivaciones"><input type="submit" id="inputExportarAExcelEncargadoActivaciones" value="Exporta a Excel" onclick="javascript:inputExportarAExcelEncargadoActivacionesOnClick(event, this)"/></div>
				<form method="post" id="formExportarAExcelEncargadoActivacionesSinDistribucion" action="#"></form>
				<div class="divButton" id="divButtonExportarAExcelEncargadoActivacionesSinDistribucion"><input type="submit" id="inputExportarAExcelEncargadoActivacionesSinDistribucion" value="Exporta a Excel" onclick="javascript:inputExportarAExcelEncargadoActivacionesSinDistribucionOnClick(event, this)"/></div>
	...
	<div id="divIFrameActivacion" style="display: none;">
		<div class="divTitleBar">
			<div class="divTitleBarText" style="float:left;">Activaci&oacute;n</div>
			<div id="divCloseIFrameActivacion" class="divTitleBarCloseButton" onclick="javascript:divCloseOnClick(event, this)">&nbsp;</div>
		</div>
		<iframe id="iFrameActivacion" src="about:blank"></iframe>
	</div>
