...
<head>
	...
	<script type="text/javascript" src="/LogisticaWEB/dwr/interface/ProcesoImportacionDWR.js"></script>
	<script type="text/javascript" src="/LogisticaWEB/dwr/interface/EstadoProcesoImportacionDWR.js"></script>
	<script type="text/javascript" src="/LogisticaWEB/dwr/interface/TipoProcesoImportacionDWR.js"></script>
	...
	<script type="text/javascript" src="/LogisticaWEB/pages/procesos_importacion/procesos_importacion.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="/LogisticaWEB/pages/procesos_importacion/procesos_importacion.css"/>
</head>
<body>
