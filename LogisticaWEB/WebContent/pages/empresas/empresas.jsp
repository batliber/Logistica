...
<head>
	...
	<script type="text/javascript" src="/LogisticaWEB/pages/empresas/empresas.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="/LogisticaWEB/pages/empresas/empresas.css"/>
</head>
<body>
...
<%@ include file="/includes/menu.jsp" %>	
	...
	<div id="divIFrameEmpresa" style="display: none;">
		...
		<iframe id="iFrameEmpresa" frameborder="0" src="#"></iframe>
	</div>
