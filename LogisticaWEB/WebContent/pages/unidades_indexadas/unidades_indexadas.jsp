...
<head>
	...
	<script type="text/javascript" src="/LogisticaWEB/pages/unidades_indexadas/unidades_indexadas.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="/LogisticaWEB/pages/unidades_indexadas/unidades_indexadas.css"/>
</head>
<body>
...
<%@ include file="/includes/menu.jsp" %>
	...
	<div id="divIFrameUnidadIndexada" style="display: none;">
		...
		<iframe id="iFrameUnidadIndexada" frameborder="0" src="#"></iframe>
	</div>
