...
<head>
	...
	<script type="text/javascript" src="/LogisticaWEB/pages/modelos/modelos.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="/LogisticaWEB/pages/modelos/modelos.css"/>
</head>
<body>
	...
	<div class="divBodyContainer">
		<div class="divBody">
			...
			<div class="divMainWindow">
				<div id="divTableModelos">&nbsp;</div>
			</div>
		</div>
	</div>
	<div id="divIFrameModelo" style="display: none;">
		<div class="divTitleBar">
			<div class="divTitleBarText" style="float:left;">Modelo</div>
			<div class="divTitleBarCloseButton" onclick="javascript:divCloseOnClick(event, this)">&nbsp;</div>
		</div>
		<iframe id="iFrameModelo" frameborder="0" src="#"></iframe>
	</div>
