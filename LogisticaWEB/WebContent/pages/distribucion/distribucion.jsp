...
<head>
	...
	<script type="text/javascript" src="/LogisticaWEB/pages/distribucion/distribucion.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="/LogisticaWEB/pages/distribucion/distribucion.css"/>
</head>
<body>
...
<%@ include file="/includes/menu.jsp" %>	
	...
	<div id="divIFrameSeleccionDistribuidor" style="display: none;">
		...
		<div id="divSeleccionDistribuidor">
			...
			<div class="divMainWindow">
				<div class="divFormLabelExtended">Distribuidor:</div><div id="divBackoffice"><select id="selectDistribuidor"></select></div>
