...
=======
			...
			<div class="divFormLabelExtended" id="divLabelNumeroSerie" id="divLabelNumeroSerie">N� de serie:</div><div id="divNumeroSerie" class="divFormValue"><input type="text" id="inputNumeroSerie"/></div>
			<div class="divFormLabelExtended" id="divLabelNumeroChip" id="divLabelNumeroChip">N� de chip:</div><div id="divNumeroChip" class="divFormValue"><input type="text" id="inputNumeroChip"/></div>
>>>>>>> branch 'master' of https://github.com/batliber/Logistica.git
