	...
	<div class="divA4Sheet">
		<div class="divA4SheetContent">
			...
			<div class="divPageContent">
				...
				<div class="divTexto">
					VALE POR LA CANTIDAD DE PESOS URUGUAYOS $U <input type="text" class="inputTotal"/> que debo/debemos y pagar&eacute;/pagaremos en forma indivisible y solidaria a XX S.A. o a su orden en <input type="text" class="inputCuotas"/> cuotas mensuales y consecutivas de $U <input type="text" class="inputValorCuota"/> cada una, venciendo la primera de ellas el d&iacute;a <input type="text" class="inputFechaVencimientoPrimeraCuota"/> y las restantes siguientes los mismos d&iacute;as de los meses sucesivos. Los pagos se realizar&aacute;n en <input type="text" class="inputFormaPago"/> (D&eacute;bito Ancel o RedPagos).
				</div>
				<div class="divTexto">
