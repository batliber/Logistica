...
<%@ include file="/includes/header.jsp" %>
	...
	<link rel="stylesheet" type="text/css" href="./cuentas.css"/>
</head>
<body>
	...
	<div class="divBodyContainer">
		<div class="divBody">
			...
			<div class="divMainWindow">
				<div id="divTableCuentas">&nbsp;</div>
			</div>
		</div>
	</div>
	<div id="divIFrameCuenta" style="display: none;">
		<div class="divTitleBar">
			<div class="divTitleBarText" style="float:left;">Cuenta</div>
			<div class="divTitleBarCloseButton" onclick="javascript:divCloseOnClick(event, this)">&nbsp;</div>
		</div>
		<iframe id="iFrameCuenta" src="about:blank"></iframe>
	</div>
