...
<%@ include file="/includes/header.jsp" %>
	...
	<script type="text/javascript" src="./riesgo_crediticio_paraguay.js"></script>
	<link rel="stylesheet" type="text/css" href="./riesgo_crediticio_paraguay.css"/>
</head>
<body>
...
<%@ include file="/includes/menu.jsp" %>
	...
	<div id="divIFrameRiesgoCrediticioParaguay" style="display: none;">
		<div class="divTitleBar">
			<div class="divTitleBarText" style="float:left;">Riesgo Crediticio PY</div>
			<div class="divTitleBarCloseButton" onclick="javascript:divCloseOnClick(event, this)">&nbsp;</div>
		</div>
		<iframe id="iFrameRiesgoCrediticioParaguay" src="about:blank"></iframe>
	</div>
		...
		<div id="divImportacionArchivo">
			...
			<div class="divPopupWindow">
				<form id="formSubirArchivo" method="POST" action="/LogisticaWEB/Upload" enctype="multipart/form-data">
					<input type="hidden" name="caller" value="/LogisticaWEB/pages/riesgo_crediticio/riesgo_crediticio_paraguay/riesgo_crediticio_paraguay.jsp"/>
