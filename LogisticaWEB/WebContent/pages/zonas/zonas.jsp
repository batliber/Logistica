...
<head>
	...
	<script type="text/javascript" src="/LogisticaWEB/pages/zonas/zonas.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="/LogisticaWEB/pages/zonas/zonas.css"/>
</head>
<body>
...
<%@ include file="/includes/menu.jsp" %>	
	...
	<div class="divMainWindow">
		<div id="divTableZonas">&nbsp;</div>
	</div>
	<div id="divIFrameZona" style="display: none;">
		<div class="divTitleBar">
			<div class="divTitleBarText" style="float:left;">Zona</div>
			<div class="divTitleBarCloseButton" onclick="javascript:divCloseOnClick(event, this)">&nbsp;</div>
		</div>
		<iframe id="iFrameZona" frameborder="0" src="#"></iframe>
	</div>
