...
<head>
	...
	<script type="text/javascript" src="/LogisticaWEB/pages/roles/roles.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="/LogisticaWEB/pages/roles/roles.css"/>
</head>
<body>
...
<%@ include file="/includes/menu.jsp" %>
	...
	<div id="divIFrameRol" style="display: none;">
		...
		<iframe id="iFrameRol" frameborder="0" src="#"></iframe>
	</div>
