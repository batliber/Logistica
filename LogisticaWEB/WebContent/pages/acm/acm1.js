...
var gridContratos = null;
var gridPrepagos = null;
var gridListaNegra = null;
var gridSinDatos = null;
...
$(document).ready(function() {
	...
	gridContratos = new Grid(
		document.getElementById("divTableContratos"),
		{
			...
			tdContratoTipoContratoDescripcion: { campo: "tipoContratoDescripcion", descripcion: "Tipo de contrato", abreviacion: "Tipo", tipo: __TIPO_CAMPO_STRING, ancho: 90 },
	...
	gridContratos.rebuild();
	
	gridPrepagos = new Grid(
		document.getElementById("divTablePrepagos"),
		{
			tdPrepagoMID: { campo: "mid", descripcion: "MID", abreviacion: "MID", tipo: __TIPO_CAMPO_NUMERICO },
			tdPrepagoMesAno: { campo: "mesAno", descripcion: "Mes/Año", abreviacion: "Mes/Año", tipo: __TIPO_CAMPO_STRING },
			tdPrepagoMontoMesActual: { campo: "montoMesActual", descripcion: "Monto actual", abreviacion: "Monto actual", tipo: __TIPO_CAMPO_NUMERICO, ancho: 80 },
			tdPrepagoMontoMesAnterior1: { campo: "montoMesAnterior1", descripcion: "Monto mes anterior 1", abreviacion: "Monto ant. 1", tipo: __TIPO_CAMPO_NUMERICO, ancho: 100 },
			tdPrepagoMontoMesAnterior2: { campo: "montoMesAnterior2", descripcion: "Monto mes anterior 2", abreviacion: "Monto ant. 2", tipo: __TIPO_CAMPO_NUMERICO, ancho: 100 },
			tdPrepagoMontoPromedio: { campo: "montoPromedio", descripcion: "Monto promedio", abreviacion: "Monto prom.", tipo: __TIPO_CAMPO_NUMERICO, ancho: 100 },
...
//			calcularMetadataConsulta(),
			gridContratos.filtroDinamico.calcularMetadataConsulta(),
			{
...
//			calcularMetadataConsulta(),
			gridPrepagos.filtroDinamico.calcularMetadataConsulta(),
			{
				callback: function(data) {
