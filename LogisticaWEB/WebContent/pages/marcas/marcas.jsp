...
<head>
	...
	<script type="text/javascript" src="/LogisticaWEB/pages/marcas/marcas.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="/LogisticaWEB/pages/marcas/marcas.css"/>
</head>
<body>
	...
	<div class="divBodyContainer">
		<div class="divBody">
			...
			<div class="divMainWindow">
				<div id="divTableMarcas">&nbsp;</div>
			</div>
		</div>
	</div>
	<div id="divIFrameMarca" style="display: none;">
		<div class="divTitleBar">
			<div class="divTitleBarText" style="float:left;">Marca</div>
			<div class="divTitleBarCloseButton" onclick="javascript:divCloseOnClick(event, this)">&nbsp;</div>
		</div>
		<iframe id="iFrameMarca" frameborder="0" src="#"></iframe>
	</div>
