...
<head>
	...
	<script type="text/javascript" src="/LogisticaWEB/dwr/interface/TipoPlanDWR.js"></script>
...
<body>
	...
	<div class="divPopupWindow">
		...
		<div class="divFormLabelExtraExtended" id="divLabelPlanPrecioMinutoDestinosAntelHorarioNormal">Precio minuto a destinos ANTEL en horario normal:</div><div id="divPlanPrecioMinutoDestinosAntelHorarioNormal" class="divFormValue"><input type="text" id="inputPlanPrecioMinutoDestinosAntelHorarioNormal"/></div>
