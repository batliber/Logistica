...
import uy.com.amensg.logistica.bean.ACMInterfacePHBean;
import uy.com.amensg.logistica.bean.IACMInterfacePHBean;
...
@WebService
public class LogisticaPHWebService {
	...
	public String getSiguienteMidSinProcesar() {
		...
		try {
			IACMInterfacePHBean iACMInterfacePHBean = lookupACMInterfacePHBean();
			
			String mid = iACMInterfacePHBean.getSiguienteMidSinProcesar();
	...
	public String getSiguienteNumeroContratoSinProcesar() {
		...
		try {
			...
			String numeroContrato = iACMInterfacePHBean.getSiguienteNumeroContratoSinProcesar();
	...
	public void actualizarDatosMidContrato(
		...
		try {
			...
			iACMInterfacePHBean.update(acmInterfaceContrato);
		} catch (Exception e) {
	...
	public void actualizarDatosMidPrepago(
		...
		try {
			...
			iACMInterfacePHBean.update(acmInterfacePrepago);
		} catch (Exception e) {
			System.err.println("Error para el MID: " + mid);
			e.printStackTrace();
		}
	...
	public void actualizarDatosMidListaVacia(String mid) {
		try {
			...
			iACMInterfacePHBean.actualizarDatosMidListaVacia(Long.parseLong(mid));
		} catch (Exception e) {
			System.err.println("Error para el MID: " + mid);
			e.printStackTrace();
		}
	...
	public void actualizarDatosMidListaNegra(String mid) {
		try {
			...
			iACMInterfacePHBean.actualizarDatosMidListaNegra(Long.parseLong(mid));
		} catch (Exception e) {
			System.err.println("Error para el MID: " + mid);
			e.printStackTrace();
		}
	...
	public void actualizarDatosMidNegociando(String mid) {
		try {
			...
			iACMInterfacePHBean.actualizarDatosMidNegociando(Long.parseLong(mid));
		} catch (Exception e) {
			System.err.println("Error para el MID: " + mid);
			e.printStackTrace();
		}
	...
	public void actualizarDatosMidNoLlamar(String mid) {
		try {
			...
			iACMInterfacePHBean.actualizarDatosMidNoLlamar(Long.parseLong(mid));
		} catch (Exception e) {
			System.err.println("Error para el MID: " + mid);
			e.printStackTrace();
		}
	...
	public void actualizarDatosNumeroContratoListaVacia(String numeroContrato) {
		try {
			...
			iACMInterfacePHBean.actualizarDatosNumeroContratoListaVacia(numeroContrato);
		} catch (Exception e) {
	...
	public void actualizarDatosPersona(
		...
		try {
			...
			if (mid != null) {
				iACMInterfacePHBean.update(acmInterfacePersona, Long.parseLong(mid));
			}
		} catch (Exception e) {
			System.err.println("Error para el MID: " + mid);
			e.printStackTrace();
	...
	private IACMInterfacePHBean lookupACMInterfacePHBean() throws NamingException {
		String prefix = "java:jboss/exported/";
		String EARName = "Logistica";
		String appName = "LogisticaEJB";
		String beanName = ACMInterfacePHBean.class.getSimpleName();
		String remoteInterfaceName = IACMInterfacePHBean.class.getName();
		String lookupName = prefix + "/" + EARName + "/" + appName + "/" + beanName + "!" + remoteInterfaceName;
		javax.naming.Context context = new InitialContext();
				
		return (IACMInterfacePHBean) context.lookup(lookupName);
	}
}