...
public class AltaANTELTO {
	...
	public String getDireccionEntregaBis() {
		return direccionEntregaBis;
	}

	public void setDireccionEntregaBis(String direccionEntregaBis) {
	...
	public String getDireccionEntregaCodigoPostal() {
		return direccionEntregaCodigoPostal;
	}

	public void setDireccionEntregaCodigoPostal(String direccionEntregaCodigoPostal) {
	...
	public String getDireccionEntregaManzana() {
		return direccionEntregaManzana;
	}

	public void setDireccionEntregaManzana(String direccionEntregaManzana) {
